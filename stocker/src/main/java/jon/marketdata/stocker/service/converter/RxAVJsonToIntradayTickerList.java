...
import jon.marketdata.stocker.interfaces.RxAVJsonToTickerList;
 ...
 */
@Component
public class RxAVJsonToIntradayTickerList
        extends RxAVJsonToTickerList<IntradayTicker, AVIntradayTicker> {

    public final static String intervalFieldName = "priceTime";

    public RxAVJsonToIntradayTickerList() { super(); }

    public RxAVJsonToIntradayTickerList(String key,
            RxAVJsonToTickerConverter<IntradayTicker, AVIntradayTicker> converter) {
